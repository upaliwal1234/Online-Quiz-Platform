                ...
                {questions.map((dataObj, index) => {
                    return (
                        <div className="p-6 bg-white border border-gray-200 rounded-lg shadow m-2 w-full">
                            ...
                            <a href="#" className="inline-flex items-center px-6 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Edit</a>
                        </div>
                    )
                })}
